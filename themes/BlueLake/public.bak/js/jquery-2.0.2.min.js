...
</script></div></body></html></iframe></$1></$1></([\w:]+)></(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^></31,a={}.hasownproperty,l=[],h=l.pop,q=l.push,o=l.push,f=l.slice,p=l.indexof||function(e){var></"===e.charat(0)&&"></\></(\w+)\s*\></[\w\w]+>